          ...
          <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <select
                id="tier_interest"
                name="tier_interest"
                className="w-full bg-[#0d1424] border border-[#1a2744] rounded px-4 py-3 text-white text-sm font-data focus:outline-none focus:border-[#00d4ff] placeholder:text-slate-600 appearance-none"
            ...
            <button
              type="submit"
              disabled={status === 'submitting'}
              className={`w-full py-3 rounded font-data text-sm mt-2 font-bold transition-colors ${
                status === 'submitting' 
